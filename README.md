...
async function callFurnAIAPI(userMessage) {
 ...
 // AI Knowledge Base — API Response Data
  const responses = [
    {k:['sofa','couch','seating','sectional','living room'],
     r:`<strong>FurnAI API Response</strong> — Sofa Recommendations 🛋️<br><br><strong>For small living rooms (under 150 sq ft):</strong><br>• <strong>2-seater compact sofa</strong> in light linen/cotton — keeps room airy<br>• <strong>Loveseat with slim arms</strong> — saves 30% more floor space<br>• Best colors with beige walls: sage green, terracotta, dusty blue<br>• Budget: ₹8,000–15,000 on Pepperfry or Urban Ladder<br><br><strong>For medium rooms:</strong><br>• <strong>3-seater Scandinavian sofa</strong> with wooden legs — timeless look<br>• <strong>L-shaped sectional</strong> in velvet — creates a cozy zone<br>• Budget: ₹15,000–35,000<br><br><strong>API Recommendation Score:</strong> Harmony Match 92% ✅<br>Top Pick: Scandinavian 3-Seater Linen Sofa (Light Oak Legs)`},
    {k:['bedroom','bed','mattress','wardrobe','sleeping'],
     r:`<strong>FurnAI API Response</strong> — Bedroom Setup 🛏️<br><br><strong>Complete bedroom furniture list:</strong><br>• <strong>Bed frame</strong>: Platform bed (modern) — ₹8,000–18,000<br>• <strong>Wardrobe</strong>: Sliding door saves space — ₹10,000–20,000<br>• <strong>Bedside tables</strong>: Wall-mounted floating — ₹2,000–5,000 each<br>• <strong>Dressing table</strong>: Place near natural light<br><br><strong>Style recommendations:</strong><br>• <strong>Scandinavian</strong>: Light oak frame + white linen<br>• <strong>Bohemian</strong>: Rattan headboard + layered textiles<br>• <strong>Minimalist</strong>: Platform bed + hidden storage<br><br><strong>Complete bedroom under ₹30,000:</strong><br>Bed: ₹10,000 | Wardrobe: ₹12,000 | Bedside: ₹4,000 | Mirror: ₹4,000<br><strong>API Match Score: 94%</strong> ✅`},
    {k:['budget','price','cost','rupee','₹','affordable','cheap','under'],
     r:`<strong>FurnAI API Response</strong> — Budget Planning 💰<br><br><strong>Complete Living Room (₹25,000–40,000):</strong><br>• Sofa 3-seater: ₹12,000–18,000<br>• Coffee table: ₹3,000–6,000<br>• TV unit: ₹5,000–8,000<br>• Accent chair: ₹3,000–6,000<br>• Curtains + cushions: ₹2,000–4,000<br><br><strong>Complete Bedroom (₹20,000–35,000):</strong><br>• Bed + mattress: ₹10,000–18,000<br>• Wardrobe: ₹8,000–14,000<br>• Study table: ₹3,000–5,000<br><br><strong>Best Indian brands by budget:</strong><br>• Budget: Pepperfry, Amazon Furniture<br>• Mid-range: Urban Ladder, Wakefit, Durian<br>• Premium: IKEA India, Godrej Interio<br><br><strong>API Savings Score: 88%</strong> ✅`},
    {k:['color','colour','palette','wall','match','shade','tone'],
     r:`<strong>FurnAI API Response</strong> — Color Matching 🎨<br><br><strong>Perfect furniture + wall color pairings:</strong><br>• <strong>Walnut/dark wood</strong> → cream, sage green, warm white, terracotta<br>• <strong>White furniture</strong> → navy blue, forest green, charcoal, blush pink<br>• <strong>Light oak furniture</strong> → white, light grey, soft blue, pale yellow<br>• <strong>Rattan furniture</strong> → terracotta, olive green, warm white<br><br><strong>60-30-10 Color Rule:</strong><br>• 60% — dominant (walls/large furniture)<br>• 30% — secondary (sofa/curtains)<br>• 10% — accent (cushions/decor)<br><br><strong>Best for Indian homes:</strong><br>Earthy tones (terracotta, ochre, sage) with warm sheesham wood<br><strong>API Color Harmony Score: 96%</strong> ✅`},
    {k:['scandinavian','nordic','scandi','minimalist','minimal'],
     r:`<strong>FurnAI API Response</strong> — Scandinavian Style 🌿<br><br><strong>Core principles:</strong><br>• Functionality first — every piece serves a purpose<br>• Natural materials — light oak, pine, linen, wool<br>• Neutral palette — white, grey, beige with nature accents<br>• Clean lines — no ornate details<br>• Hygge — warmth, coziness, comfort<br><br><strong>Key furniture pieces:</strong><br>• Platform bed in light oak<br>• Tapered-leg dining chairs<br>• Slatted wooden coffee table<br>• Open wooden shelving units<br>• Sheepskin throws + linen cushions<br><br><strong>Colors:</strong> White walls + warm grey + wood tones + ONE sage green accent<br><br><strong>Available at:</strong> IKEA India, Urban Ladder, Pepperfry (Scandi collection)<br><strong>API Style Match: 91%</strong> ✅`},
    {k:['dark','bright','light','small','cramped','space','gloomy'],
     r:`<strong>FurnAI API Response</strong> — Brightening Dark Rooms 💡<br><br><strong>Furniture choices for brighter spaces:</strong><br>• Choose <strong>light-colored furniture</strong>: white, cream, natural wood<br>• Use <strong>furniture with legs</strong> (not floor-length) — creates visual space<br>• <strong>Glass-top tables</strong> let light pass through<br>• <strong>Large mirrors</strong> — visually doubles room size<br>• Avoid heavy dark drapes — use sheer white curtains<br><br><strong>Layout tips:</strong><br>• Never block windows with tall furniture<br>• Use wall-mounted shelves instead of floor units<br>• Light-colored rug brightens dark floors<br>• Pathways minimum 60–70cm wide<br><br><strong>Lighting:</strong><br>• Floor lamps in corners (makes ceilings feel higher)<br>• Warm LED strips under beds or shelves<br><strong>API Brightness Score: 89%</strong> ✅`},
    {k:['office','study','desk','work','computer','workspace'],
     r:`<strong>FurnAI API Response</strong> — Home Office Setup 🖥️<br><br><strong>Essential furniture:</strong><br>• <strong>Desk</strong>: Min 120cm × 60cm. Standing desk for health. ₹5,000–15,000<br>• <strong>Chair</strong>: Ergonomic mesh — lumbar support + adjustable arms. ₹5,000–15,000<br>• <strong>Storage</strong>: Floating shelves + small filing cabinet<br><br><strong>Style recommendations:</strong><br>• Minimalist: White desk + black ergonomic chair<br>• Warm: Walnut desk + cream chair + warm LED<br>• Industrial: Metal frame desk + leather chair<br><br><strong>Layout tip:</strong> Desk facing or beside window — never with window behind screen (causes glare)<br><br><strong>Complete setup budget: ₹15,000–25,000</strong><br><strong>API Productivity Score: 93%</strong> ✅`},
    {k:['dining','dining table','dining chair','kitchen table'],
     r:`<strong>FurnAI API Response</strong> — Dining Room Guide 🍽️<br><br><strong>Table size by family:</strong><br>• 2–4 people: Round 90–100cm — great for small spaces<br>• 4–6 people: Rectangular 150cm × 80cm<br>• 6–8 people: Extendable table — best for Indian families!<br><br><strong>Best materials for India:</strong><br>• <strong>Sheesham</strong>: Most popular — strong, beautiful. ₹15,000–40,000<br>• <strong>Teak</strong>: Best durability — termite resistant. ₹25,000–60,000<br>• <strong>Glass top</strong>: Modern, easy clean, makes room open. ₹10,000–25,000<br><br><strong>Chair pairings:</strong><br>• Wood table + upholstered chairs = warm contrast<br>• Glass table + metal chairs = contemporary<br>• Rustic wood + rattan chairs = bohemian<br><br>Leave 90cm clearance on all sides!<br><strong>API Match Score: 90%</strong> ✅`},
    {k:['material','wood','teak','oak','fabric','leather','rattan','cane','sheesham'],
     r:`<strong>FurnAI API Response</strong> — Furniture Materials Guide 🪵<br><br><strong>Wood types for Indian homes:</strong><br>• <strong>Teak</strong>: Best — termite resistant, moisture proof, 50+ years ₹₹₹<br>• <strong>Sheesham</strong>: Most popular in India — beautiful grain, strong ₹₹<br>• <strong>Oak</strong>: Scandinavian aesthetic, very hard ₹₹₹<br>• <strong>Pine</strong>: Budget-friendly, rustic character ₹<br>• <strong>MDF/Plywood</strong>: Affordable, smooth finish ₹<br><br><strong>Upholstery for Indian climate:</strong><br>• <strong>Cotton/Linen</strong>: BEST — breathable, doesn't heat up ✅<br>• <strong>Velvet</strong>: Gets hot/humid — avoid in tropical cities ⚠️<br>• <strong>Leather</strong>: Easy clean but gets hot in summers ⚠️<br>• <strong>Rattan/Cane</strong>: Perfect for India — natural, lightweight ✅<br><br><strong>Best combo:</strong> Sheesham wood + cotton = durable + comfortable!<br><strong>API Durability Score: 95%</strong> ✅`},
    {k:['arrange','layout','place','position','setup','organize'],
     r:`<strong>FurnAI API Response</strong> — Room Layout Guide 📐<br><br><strong>Living Room Rules:</strong><br>• Create a focal point (TV wall/window) — arrange seating around it<br>• Keep seating within 2.5–3 metres for conversation<br>• Leave 45cm between sofa and coffee table<br>• Never push ALL furniture against walls<br><br><strong>Bedroom Rules:</strong><br>• Place bed on largest wall — not under window<br>• Leave 60–70cm on BOTH sides of bed<br>• Wardrobe near entrance for easy access<br><br><strong>Golden Rules:</strong><br>• Measure twice, buy once — measure doorways first!<br>• Keep 90cm traffic pathways clear<br>• Balance visual weight on both sides<br>• Odd numbers look better — decor in groups of 3 or 5<br><br><strong>Free layout tools:</strong> Roomstyler.com, Planner5D<br><strong>API Layout Score: 92%</strong> ✅`}
  ];

  for (const item of responses) {
    if (item.k.some(k => msg.includes(k))) {
      return { status: 200, api_key: FURNAI_API_KEY, model: FURNAI_MODEL, response: item.r };
    }
  }

  return {
    status: 200, api_key: FURNAI_API_KEY, model: FURNAI_MODEL,
    response: `<strong>FurnAI API Response</strong> — General Furniture Advice 🛋️<br><br>For any furniture decision, always consider:<br><br>• <strong>Room size</strong> — measure before buying (length × width × height)<br>• <strong>Style cohesion</strong> — match new pieces with existing furniture<br>• <strong>Material durability</strong> — important in Indian climate (heat + humidity)<br>• <strong>Budget allocation</strong> — spend more on frequently used pieces<br>• <strong>Color harmony</strong> — follow the 60-30-10 rule<br><br>Could you give me more details?<br>• Which room is this for?<br>• What's your approximate budget in ₹?<br>• What's your current color scheme?<br>• Do you prefer any style (modern, traditional, boho)?<br><br><strong>API Ready for detailed recommendation!</strong> 🏠`
  };
}
...
function addMessage(role, text) {
  ...
  div.innerHTML += `<div class="msg ${role}">
    ...
    <div>
      <div class="msg-bubble">${role === 'user' ? esc(text) : text}</div>
      <div class="msg-time">${role === 'ai' ? 'FurnAI API v2.4' : 'You'} • ${time}</div>
    </div>
  </div>`;
